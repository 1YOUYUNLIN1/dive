(window.__twttrll = window.__twttrll || []).push([[2], {
    160: function(t, e, n) {
        var r = n(39)
          , a = n(162)
          , s = n(7);
        (r = Object.create(r)).build = s(r.build, null, a),
        t.exports = r
    },
    161: function(t, e, n) {
        var r = n(71)
        ...
        t.exports = function(t) {
            ...
            t.define("scribe", function(t, e, n) {
                ...
                return s.getHorizonSettings().then(function(s) {
                    ...
                    t = o.aug(a.scribeNamespace(), t || {}),
                    e = o.aug(a.scribeData(), e || {}),
                    r.clientEvent(t, e, !1, n, i)
                })
            }),
            t.define("scribeInteraction", function(t, e, n) {
                var r = a.extractTermsFromDOM(t.target);
                return r.action = t.type,
                "url" === r.element && (r.element = a.clickEventElement(t.target)),
                this.scribe(r, e, n)
            })
        }
    },
    162: function(t, e, n) {
        ...
        a.aug(i.prototype, {
            ...
            selectors: function(t) {
                ...
                t = t || {},
                this.Widget.prototype.selectors = a.aug({}, t, e)
            }
        }),
        t.exports = i
    },
        ...
        t.exports = function() {
            ...
            i.aug(e.prototype, {
                ...
                select: function(t, e) {
                    ...
                    t = this.el),
                    t ? (e = this.selectors[e] || e,
                    i.toRealArray(t.querySelectorAll(e))) : []
                },
                selectOne: function() {
    ...
    181: function(t, e, n) {
        ...
        t.exports = a.couple(n(161), n(166), function(t) {
            ...
            t.override("render", function() {
                ...
                return this.scribeImpression(),
                r.all([this.sandbox.setTitle(m), this.sandbox.addClass(d), this.sandbox.loadDocument(n)])
            })
        })
    },
    182: function(t, e, n) {
    ...
    199: function(t, e, n) {
        ...
        t.exports = f.couple(n(161), n(166), function(t) {
            ...
            t.define("getUrlParams", function() {
                ...
                return "share" === this.params.type ? (t = t || a.title,
                e = e || c.getCanonicalURL() || s.href,
                n = n || i) : i && (r = r ? i + "," + r : i),
                l.compact({
                    id: this.id,
                    lang: this.params.lang,
            ...
            t.override("render", function() {
                var t, e = u(b, {
                    lang: this.params.lang
                }), n = h.encode(this.getUrlParams()), a = d.resourceBaseUrl + e + "#" + n;
                ...
                return this.scribeImpression(),
                r.all([this.sandbox.setTitle(w), this.sandbox.addClass(v), this.sandbox.addClass(t), this.sandbox.loadDocument(a)])
            })
        })
    },
    76: function(t, e, n) {
